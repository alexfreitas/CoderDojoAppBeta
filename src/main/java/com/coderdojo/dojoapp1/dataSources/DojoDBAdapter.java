...
public class DojoDBAdapter {
    ...
    public static final String KEY_HISTORY = "_history";
     ...
     * is successfully created return the new userID for that participant, otherwise return
     * a -1 to indicate failure.
     *
     * @param name the name of the participant
     * @param history the times particpant has presented
     * @return userID or -1 if failed
     */
    public long createParticipant(String name, String history) {
    ...
    /**
     * Delete the participant with the given userID
     *
     * @param userID id of participant to delete
     * @return true if deleted, false otherwise
     */
    public boolean deleteParticipant(long userID) {
    ...
    public Cursor fetchAllParticipants() {
        ...
        return mDb.query(DATABASE_TABLE, new String[]{KEY_USERID, KEY_NAME, KEY_HISTORY}, null, null, null, null, null);
    }

    /**
     * Return a Cursor positioned at the participant that matches the given userID
     *
     * @param userID id of participant to retrieve
     * @return Cursor positioned to matching participant, if found
     * @throws SQLException if participant could not be found/retrieved
     */
    public Cursor fetchParticipant(long userID) throws SQLException {

        Cursor mCursor =

                mDb.query(true, DATABASE_TABLE, new String[] {KEY_USERID,
                                KEY_NAME, KEY_HISTORY}, KEY_USERID + "=" + userID, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     * updated is specified using the userID, and it is altered to use the name
     * and position values passed in
     *
     * @param userID id of participant to update
     * @param name value to set participant title to
     * @param posi value to set participant body to
     * @return true if the note was successfully updated, false otherwise
     */
    public boolean updateParticipant(long userID, String name, int posi) {
