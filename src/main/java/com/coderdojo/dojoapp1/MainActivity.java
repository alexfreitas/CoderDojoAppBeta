...
public class MainActivity extends Activity {
    ...
    public static ArrayList<Kid> mKidsData;

    public static DojoDBAdapter dataTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataTable = new DojoDBAdapter(this);
        dataTable = dataTable.open();
    ...
    public void onClickDataRead(View view){
        Log.d(TAG, "onClickLightningRound entered");

        Intent intent = new Intent(this, DataUpload.class);
        startActivity(intent);
